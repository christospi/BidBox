    ...
    <nav class="navbar navbar-default navbar-static-top">
        <div class="container-fluid">
            ...
            <div id="triangle-topleft">
                <img class="penguin" src="../img/peng-old.png" height="130" width="285" >
            </div>
            ...
            <ul class="nav  nav-pills navbar-right">
                ...
                <li class="active"><a href="./../BBservlet?action=auctionlist&username=<%=user2.username%>&page_num=1">My Auctions</a>
